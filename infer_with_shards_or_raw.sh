...
per_gpu_processes=4  # 每个GPU上的进程数
data_type="raw"  # 数据类型，raw或shards_full_data
task_name="asr_think"  # 任务名称，asr_think或asr_chat

test_data_path="/home/A02_tmpdata2/data/context_asr_sentence_few/wav_shards/shards/test_raw_data/data.list"
infer_res_path="/home/A02_tmpdata2/ckpt/osum_chat_new_start_0810/context_asr/epoch0/step_9999_infer_common/infer_res.scp"
gpu_ids=(0 1 2 3 4 5 6 7)  # GPU ID列表（可根据实际可用GPU修改）
per_gpu_processes=1  # 每个GPU上的进程数
data_type="raw"  # 数据类型，raw或shards_full_data
task_name="asr"  # 任务名称，asr_think或asr_chat
