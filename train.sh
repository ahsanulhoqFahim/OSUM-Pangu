...
train_config=conf/ct_config_open_pangu.yaml
gxl_data_json_info_path_s2t=conf/data_s2t_tmp.yaml     #conf/data_s2t_tmp.yaml
gxl_data_json_info_path_t2s=conf/empty.yaml
gxl_data_json_info_path_s2s=conf/empty.yaml
gxl_data_json_info_path_t2t=conf/data_t2t_tmp.yaml         #data_t2t_tmp.yaml
# ---------------------------------

checkpoint=step_819499.pt
