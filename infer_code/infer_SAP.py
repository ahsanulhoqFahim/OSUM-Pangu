...
# 原有：批量推理wav.scp格式文件
def batch_inference_s2t(wav_scp_path, output_txt_path, prompt="你能听一下这段录音，告诉我说了啥，还有说话的人大概多大年纪？"):
    """
...
def batch_inference_s2t_json_list(json_list_path, output_txt_path, prompt="你能听一下这段录音，告诉我说了啥，还有说话的人大概多大年纪？"):
    """
...
if __name__ == "__main__":
    ...
    warmup_prompt = "你能听一下这段录音，告诉我说了啥，还有说话的人大概多大年纪？"
    print(f"正在预热 ...")
    try:
