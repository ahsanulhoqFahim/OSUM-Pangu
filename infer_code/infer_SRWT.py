...
# 原有：批量推理wav.scp格式文件
def batch_inference_s2t(wav_scp_path, output_txt_path, prompt="把这段音频里的内容写出来，每个词和字都标上时间"):
    """
...
def batch_inference_s2t_json_list(json_list_path, output_txt_path, prompt="把这段音频里的内容写出来，每个词和字都标上时间"):
    """
...
if __name__ == "__main__":
    ...
    warmup_prompt = "把这段音频里的内容写出来，每个词和字都标上时间"
    print(f"正在预热 ...")
    try:
