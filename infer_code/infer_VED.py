...
# 原有：批量推理wav.scp格式文件
def batch_inference_s2t(wav_scp_path, output_txt_path, prompt="你帮我听听这段录音，然后把里面的内容写下来，还有标出里面发生的事"):
    """
...
def batch_inference_s2t_json_list(json_list_path, output_txt_path, prompt="你帮我听听这段录音，然后把里面的内容写下来，还有标出里面发生的事"):
    """
...
if __name__ == "__main__":
    ...
    warmup_prompt = "你帮我听听这段录音，然后把里面的内容写下来，还有标出里面发生的事"
    print(f"正在预热 ...")
    try:
