...
# 原有：批量推理wav.scp格式文件
def batch_inference_s2t(wav_scp_path, output_txt_path, prompt="你听一下这段录音，然后说说里面都说了啥，还有里面的人情绪怎么样？"):
    """
...
def batch_inference_s2t_json_list(json_list_path, output_txt_path, prompt="你听一下这段录音，然后说说里面都说了啥，还有里面的人情绪怎么样？"):
    """
...
if __name__ == "__main__":
    print("开始预热模型...")
    warmup_wav_path = "Ses04M_script02_1_F002.wav"
    warmup_prompt = "你听一下这段录音，然后说说里面都说了啥，还有里面的人情绪怎么样？"
    print(f"正在预热 ...")
    try:
