...
# 原有：批量推理wav.scp格式文件
def batch_inference_s2t(wav_scp_path, output_txt_path, prompt="你能听这段语音然后告诉我内容吗？"):
    """
...
def batch_inference_s2t_json_list(json_list_path, output_txt_path, prompt="你能听这段语音然后告诉我内容吗？"):
    """
