...
# 原有：批量推理wav.scp格式文件
def batch_inference_s2t(wav_scp_path, output_txt_path, prompt="这段音频里说的啥，能不能告诉我，还有说话的人是男是女？"):
    """
...
def batch_inference_s2t_json_list(json_list_path, output_txt_path, prompt="这段音频里说的啥，能不能告诉我，还有说话的人是男是女？"):
    """
...
if __name__ == "__main__":
    ...
    warmup_prompt = "这段音频里说的啥，能不能告诉我，还有说话的人是男是女？"
    print(f"正在预热 ...")
    try:
